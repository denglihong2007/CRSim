...
本软件为**铁路信息显示仿真工具**，所有数据为用户虚构，与铁路官方无任何关联。

本仓库的核心代码以 GPLv3 许可开源。
项目包含的 12306 模拟功能为可选组件，其以独立二进制形式分发，并受单独的 EULA 协议约束。该模块不属于本仓库 GPLv3 开源范围。

**如需使用该功能，请接受其 EULA 中的内容（文件位于`NuGet`包根目录）。**
